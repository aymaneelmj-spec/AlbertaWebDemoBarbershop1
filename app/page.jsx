      ...
      <section id="contact" className="py-24 px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto items-stretch">
          ...
          <div className="rounded-xl overflow-hidden border border-gold/20 h-[450px] bg-dark2 relative">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d37888.8756449198!2d-113.4674514317796!3d53.59248511836368!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53a023cf8bd7bd03A0xb41bd5e899d57e96!2sFaded0Barbershop!5e0!3m2!1sen!2sma!4v1785111760738!5m2!1sen!2sma" width="100%" height="100%" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="strict-origin-when-cross-origin"></iframe>
          </div>
        </div>
