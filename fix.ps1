...
export default function Navbar() {
  ...
  const navClass = "fixed w-full bg-black/80 backdrop-blur-md z-50 border-b border-gold/20 transition-transform duration-300 " + (show ? "translate-y-0" : "-translate-y-full");
...
Write-Host "SUCCESS! Navbar syntax error fixed." -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green