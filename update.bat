@echo off
chcp 65001 >nul
title Fixing Maps, Background, and Duplicate Images
...
>>fix.ps1 echo   { day: 'Sunday', time: '10 AM–5 PM' },
>>fix.ps1 echo   { day: 'Monday', time: '9:30 AM–7 PM' },
>>fix.ps1 echo   { day: 'Tuesday', time: '9:30 AM–7 PM' },
>>fix.ps1 echo   { day: 'Wednesday', time: '9:30 AM–7 PM' },
>>fix.ps1 echo   { day: 'Thursday', time: '9:30 AM–7 PM' },
>>fix.ps1 echo   { day: 'Friday', time: '9:30 AM–7 PM' },
>>fix.ps1 echo   { day: 'Saturday', time: '9:30 AM–7 PM' }
>>fix.ps1 echo ];
...
>>fix.ps1 echo           ^</div^>
>>fix.ps1 echo           ^<div className="rounded-xl overflow-hidden border border-gold/20 h-[450px] bg-dark2"^>
>>fix.ps1 echo             ^<iframe src="https://maps.google.com/maps?q=6610+127+Ave+NW,+Edmonton,+AB^&z=15^&output=embed" width="100%%" height="100%%" style={{border:0}} allowFullScreen="" loading="lazy"^>^</iframe^>
>>fix.ps1 echo           ^</div^>
>>fix.ps1 echo         ^</div^>
...
echo ==========================================
echo SUCCESS! 
echo - Google Maps is now fully interactive.
echo - Hero background is now high-definition and cinematic.
echo - Duplicate image removed.
echo ==========================================
pause